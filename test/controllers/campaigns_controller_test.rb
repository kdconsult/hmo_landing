...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { active: @campaign.active, body: @campaign.body, end_date: @campaign.end_date, slug: @campaign.slug, start_date: @campaign.start_date, title: @campaign.title } }
